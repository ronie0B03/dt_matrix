<template>
  <div>
          ...
          <md-card-content>
            <div class="md-layout">
              ...
              <div class="md-layout-item md-small-size-100 md-size-33">
                ...
                <md-radio v-model="gradeGWA" :value="1">Greater than or Equal 2</md-radio>
              </div>
              ...
              <div class="md-layout-item md-small-size-100 md-size-33">
                ...
                <md-radio v-model="currentProgram" :value="1">BIT-FOODS</md-radio>
                <md-radio v-model="currentProgram" :value="2">BIT-AUTO</md-radio>
                <md-radio v-model="currentProgram" :value="3">BIT-DRAFT</md-radio>
                <md-radio v-model="currentProgram" :value="4">BIT-ELECTRICAL</md-radio>
                <md-radio v-model="currentProgram" :value="5">BSED-ENG</md-radio>
                <md-radio v-model="currentProgram" :value="6">BPED</md-radio>
                <md-radio v-model="currentProgram" :value="7">BSED-GEN ED</md-radio>
                <md-radio v-model="currentProgram" :value="8">BSBA</md-radio>
                <md-radio v-model="currentProgram" :value="9">BS-ENTREP</md-radio>
                <md-radio v-model="currentProgram" :value="10">HRM</md-radio>
                <md-radio v-model="currentProgram" :value="11">COMP-ENGR</md-radio>
    ...
    <div v-if="replied">
      <md-card>
        <md-card-content>
          Your Recommended program is: {{ recommendedProgramTitle }}
        </md-card-content>
